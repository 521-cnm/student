...
public class Change extends JFrame {
	public Change() {
			...
			add(lab5);
			bu1.addActionListener(new ActionListener() {//修改按钮监听
				public void actionPerformed(ActionEvent e) {
					 try{
				      ...
				      String sql="update student set stuNum=?,name=?,sex=?,age=?,address=?,collage=?,major=? where id=? ";//生成一条mysql语句
